// components/admin/NewArrivals.jsx
...
const NewArrivals = ({ 
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      console.error('Failed to update new arrivals:', error);
    }
  };
    ...
    return (
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Add to New Arrivals</h2>
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-gray-600 mb-6">
            Click "Edit List" to add products to New Arrivals
          </p>
          <button
            onClick={handleEditClick}
