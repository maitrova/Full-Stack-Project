...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: 'Combo Packs', icon: 'M20 7.5l-8-4.5-8 4.5m16 0l-8 4.5m8-4.5v9l-8 4.5m0-9L4 7.5m8 4.5v9M4 7.5v9l8 4.5M7 10.5l8-4.5M17 10.5l-8-4.5', path: '/adminpage/combo-packs' },
